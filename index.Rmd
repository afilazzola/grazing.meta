...
source("meta.eval.r") ## Multiple aggregate
  ...
  ## drop Lichen, Microbes and fungi
    meta2 <- meta2 %>% filter(Taxa != "Plants" & Higher.Taxa != "Lichen" & Higher.Taxa != "Microbial") ## examine animals only
  ...
  meta2[,"UniqueSite"] <- paste(meta2$uniqueID, meta2$Higher.Taxa, meta2$Taxa, meta2$Functional.Group, meta2$estimate.simplified, sep="-")
