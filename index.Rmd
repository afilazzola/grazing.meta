...
### Temperature only
#mixed-effects meta-analysis for grazed vs ungrazed plots
m3 <- rma(yi=yi, vi=vi, mods=~ poly(temp,1),  data = meta.ready)
summary(m3) 
...
#mixed-effects meta-analysis for grazed vs ungrazed plots
m4 <- rma(yi=yi, vi=vi, mods=~ poly(precip,2),  data = meta.ready)
summary(m4) 
...
m4 <- rma(yi=yi, vi=vi, mods=~ poly(aridity,2),  data = test)
summary(m4) 
