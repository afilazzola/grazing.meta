...
source("meta.eval.r") ## Multiple aggregate
  ...
  m2 <- rma(yi=yi, vi=vi, mods=~ -1 + FG,  data = meta.ready, digits=4 )
  summary(m2) 
...
### add points
col <- data.frame(FG=unique(meta.ready$FG), colors= c( "#D55E00", "#56B4E9", "#0072B2", "#009E73", "#F0E442", "#E69F00", "#CC79A7"))
...
legend(0,5.5, legend=col$FG, col=as.character(col$colors), pch=19, cex=0.8)
